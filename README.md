...
To use these, clone the repository somewhere in your workspace folder and add the path to [`workspace.library`](https://luals.github.io/wiki/settings/#workspacelibrary) in your `.luarc.json` or VS Code workspace settings.
